...
<!-- Step #3: http://localhost:8000/dictionary4.php -->

<!--
4. Use a foreach loop to print out all the definitions, reversing the order of the letters with the strrev function.
-->
<?php 
    $word1 = $_GET["word1"];
    $word2 = $_GET["word2"];
        ...
        <ul>
          <?php             
              foreach ($dictionary as $word => $definition) {
                  $definition_reversed = strrev($definition);
                  echo "<li>" . "$word: $definition_reversed" . "</li>";
              }
          ?>
        </ul>
    </div>
