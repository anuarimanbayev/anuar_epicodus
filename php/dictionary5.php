...
<!-- Step #3: http://localhost:8000/dictionary5.php -->

<!--
5A. Add 2 more words and definitions to your dictionary.
5B. Use a foreach loop to print out all the keys and definitions in the browser. The keys should be displayed with <h1> tags and the values should be displayed with <h3> tags.
-->
<?php 
    $word1 = $_GET["word1"];
    $word2 = $_GET["word2"];
...
<body>
    <div class="container">
        ...
        <?php
            $dictionary["berkut"] = "golden eagle hunting domesticated bird";
            $dictionary["atli"] = "steppe pony horse that is short in shoulder height but long in torso.";              
            foreach ($dictionary as $word => $definition) {
                $string1 = "<h1>$word: </h1>";
                $string2 = "<h3>$definition</h3>";
